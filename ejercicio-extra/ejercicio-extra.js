...
for (let i = 0; i < images.length; i++) {
    galeria += `<div class="col-lg-3 col-md-4 col-6">
...
const sectionGallery = document.querySelector(".container")

sectionGallery.innerHTML = `<div class="container">
        <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0">Bootstrap Thumbnail Gallery</h1>
        <hr class="mt-2 mb-5">
