...
const sectionOurClients = document.querySelector("#our-clients")

sectionOurClients.innerHTML = `<div class="container-our-clients">
<div class="header-our-clients">
  <h3 class="h3-our-clients">Our CLients</h3>
  <p class="text-our-clients">
...
for (let i = 0; i < cards.length; i++) {
  services += `<div class="services__card">
...
sectionServices.innerHTML = `<div class="services__container">
      <header>
        <h1>Services</h1>
